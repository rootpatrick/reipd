...
<div class="main-nav">
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">                 
              <li><a href="<%=c.domain()%>Admin/new.jsp">Nouveau Administrateur</a></li>
               <li><a href="<%=c.domain()%>Admin/action.jsp">Nouvelle Action</a></li>
               <li><a href="<%=c.domain()%>Admin/logout.jsp">Deconnectez-Vous</a></li>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
            ...
            <button type="button" class="btn btn-primary" style="border-radius: 10px;" data-toggle="modal" data-target="#mod<%= c.rs.getString(1)%>al"">
                ...
                <a class="btn-primary" style="border-radius: 10px;" href="<%=c.domain()%>Admin/article.jsp?id=<%=c.rs.getString(1)%>">Voir toutes Les Activites</a>
...
c.getcon().close();
 ...
 <%
    ...
    if (request.getParameter("log")!=null && !request.getParameter("country").equals("tout")) 
    {
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <p class="pull-right">Designed by <a href="http://www.themeum.com/">bojospelic</a></p>
          </div>
        </div>
      </div>
    </div>
